...
setInterval(yanchi1,1000);

/*body3 的出现*/
var body3 = document.getElementsByClassName("body3")[0];
var zhan1 = document.getElementsByClassName("zhan")[1];
function yanchi5(){
	if(window.pageYOffset > 250){
		body3.style.display = "block";
		zhan1.style.display = "none";
	}
}
setInterval(yanchi5,1000);

/*body4的出现*/
var body4 = document.getElementsByClassName("body4")[0];
var zhan2 = document.getElementsByClassName("zhan")[2];
function yanchi6(){
	if(window.pageYOffset > 650){
		body4.style.display = "block";
		zhan2.style.display = "none";
	}
}
setInterval(yanchi6,1000);
...
/*body4奇葩*/
for(var j = 0; j < 4 ; j++){
	var li1 = document.getElementsByClassName("li1")[j];
		li1.onmouseenter = function(){

				var span1 = this.children[0];
				var span2 = span1.children;
				for(var a = 1; a <7 ;a ++){
					var span2 = span1.children[a];
					span2.style.display = "block";
				}
				for(var b = 1; b <=4 ; b++){
					var span2 = span1.children[b];
